...
void devourer( player_t* p )
{
  ...
  default_->add_action( "call_action_list,name=reaps,if=action.reap.souls_consumed>=4&(fury+action.reap.souls_consumed*4+10)>=100&fury<=84&(!talent.the_hunt|!talent.voidsurge)", "Reap Line - Efficient Generator" );
