...
void unholy( player_t* p )
{
  ...
  san_st->add_action( "festering_strike,if=(debuff.festering_wound.stack=0&cooldown.apocalypse.remains<variable.apoc_timing)|cooldown.dark_transformation.remains<10&debuff.festering_wound.stack<=3&rune>4|(talent.gift_of_the_sanlayn&!buff.gift_of_the_sanlayn.up|!talent.gift_of_the_sanlayn)&debuff.festering_wound.stack<=1" );
