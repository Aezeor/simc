...
void arcane( player_t* p )
{
  ...
  precombat->add_action( "variable,name=soul_burst,default=0,op=reset", "Option to sim offsetting your primary burst into the Arcane Soul window as Sunfury." );
