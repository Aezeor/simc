...
HEADERS += engine/class_modules/apl/apl_shaman.hpp
...
HEADERS += engine/class_modules/monk/sc_stagger.hpp
...
HEADERS += engine/dbc/assisted_combat.hpp
...
HEADERS += engine/dbc/wow_version.hpp
...
HEADERS += engine/player/unique_gear_midnight.hpp
...
HEADERS += engine/sim/proc_rng.hpp
...
SOURCES += engine/class_modules/apl/apl_shaman.cpp
...
SOURCES += engine/class_modules/monk/sc_stagger.cpp
...
SOURCES += engine/class_modules/warlock/sc_warlock_actions.cpp
...
SOURCES += engine/dbc/assisted_combat.cpp
...
SOURCES += engine/dbc/wow_version.cpp
...
SOURCES += engine/lib/fmt/format.cc
SOURCES += engine/lib/fmt/os.cc
...
SOURCES += engine/player/unique_gear_midnight.cpp
...
SOURCES += engine/sim/proc_rng.cpp
